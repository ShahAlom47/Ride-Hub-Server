...
import updateBikeView, { addBike, deleteBike, editBikeData, editBikePhoto, getBikeData, getBikeDetails, getLatestBikes, getWishListData, updateBikeRentStatus } from '../Controller/bikeData.controller';
